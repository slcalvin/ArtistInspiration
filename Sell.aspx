<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sell.aspx.cs" Inherits="ArtistInspiration.Sell" %>
  ...
  <ucl:Navigation ID="Navigation" runat="server" />
    ...
    <!-- Left and right controls -->
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style3">&nbsp;&nbsp;&nbsp;&nbsp;Sell Amount:&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td class="auto-style5">
                    <asp:TextBox ID="Sbtxt" runat="server"></asp:TextBox>
                </td>
                <td>
                 &nbsp;&nbsp;&nbsp;&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Sell amount is required." SetFocusOnError="true" ControlToValidate="Sbtxt" CssClass="error"></asp:RequiredFieldValidator>
                 &nbsp;&nbsp;&nbsp;&nbsp;<asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="Sbtxt" ErrorMessage="Enter a sell amount between 1 and 100." MaximumValue="100" MinimumValue="1" Type="Integer" CssClass="error" />
                </td>
            ...
            <tr>
                <td class="auto-style3">&nbsp;</td>
                <td class="auto-style5">
                    <asp:Button ID="submit" runat="server" Text="Sell" />
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
